...
@Entity
@Table(name = "t_physical_facility_budget")
public class PhysicalFacilityBudget {
	...
	public String toString() {
		return "PhysicalFacilityBudget [physicalFacilityBudgetId=" + physicalFacilityBudgetId + ", finYearId="
