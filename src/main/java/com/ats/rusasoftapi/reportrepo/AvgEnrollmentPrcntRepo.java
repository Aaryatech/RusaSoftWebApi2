...
public interface AvgEnrollmentPrcntRepo extends JpaRepository<AvgEnrollmentPrcnt, Integer>  {
	...
	/*
	 * @Query(value="SELECT" + "        m_academic_year.academic_year," +
	 * "        m_academic_year.year_id," + "        m_institute.institute_name," +
	 ...
	 * + "    FROM" + "  		 t_prog_sanc_intake," +
	 * "        t_institute_info_detail," + "        m_academic_year," +
	 * "        m_institute      " + "    WHERE" +
